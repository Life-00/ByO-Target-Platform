...
# 업스테이지 임베딩 제한(4000) 대비 여유 값 추천: 3200~3500
DEFAULT_MAX_TOKENS = int(os.getenv("EMBEDDING_MAX_TOKENS", "3200"))
DEFAULT_OVERLAP_TOKENS = int(os.getenv("EMBEDDING_OVERLAP_TOKENS", "200"))
...
def chunk_text_by_tokens(
    ...
    - max_tokens: 업스테이지 4000 제한이면 3000~3500 권장
    """
    text = (text or "").strip()
    if not text:
        return []
